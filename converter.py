...
chord_shapes = {
    'maj': {'offsets':      [0, 2, 4, 7, 9, 12, 14, 16, 17, 19, 21, 24, 26]},
    'maj7': {'offsets':     [0, 2, 3, 4, 7, 9, 11, 12, 14, 16, 17, 19, 21]},
    'min': {'offsets':      [0, 2, 3, 7, 9, 12, 14, 15, 19, 21, 24, 26, 27]},
    'min7': {'offsets':     [0, 2, 3, 6, 7, 9, 10, 12, 14, 15, 17, 19, 21]},
